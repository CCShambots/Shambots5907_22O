...
public class MotorConfiguration {
    ...
    public static void configureVelocityMotor(WPI_TalonFX motor, PIDFGains gains) {configureVelocityMotor(motor, gains, 0, 0, Constants.CURRENT_LIMIT, 30);}

    public static void configureVelocityMotor(WPI_TalonFX motor, PIDFGains gains, int kSlotIdx, int kPIDLoopIdx, SupplyCurrentLimitConfiguration currentLimit, int kTimeoutMs) {
    ...
    public static void configureMotionMagicMotor(WPI_TalonFX motor, PIDFGains gains, double maxVelo, double maxAccel) { configureMotionMagicMotor(motor, gains, 0, 0, maxVelo, maxAccel, Constants.CURRENT_LIMIT, 30);}

    public static void configureMotionMagicMotor(WPI_TalonFX motor, PIDFGains gains, int kSlotIdx, int kPIDLoopIdx, double maxSpeed, double maxAccel, SupplyCurrentLimitConfiguration currentLimit, int kTimeoutMs) {
        motor.setSensorPhase(false);
        motor.configSupplyCurrentLimit(currentLimit);
